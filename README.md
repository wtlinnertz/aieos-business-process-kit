...
This kit is one layer of the [AIEOS](https://github.com/wtlinnertz) governance framework. It follows the standard four-file system (spec, template, prompt, validator) and integrates with the Engineering Execution Kit (upstream) and Release & Exposure Kit (downstream).
